...
plot(hclust_result, hang=-1, labels=bike_sample$season, cex=.5)
...
Die Luftfeuchtigkeit scheint auch einen Rinfluss zu haben. Cluster 3 hat mehr Verkäufe pro Tag 
